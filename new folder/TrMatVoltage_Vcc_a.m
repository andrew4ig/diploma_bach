...
a=3e-9;
b1=2e-9;                    b2=2e-9;
U1=X1*0.74;                 U2=X2*0.74;
m1=0.067*m0;
m21=(0.067+0.083*X1)*m0;    m22=(0.067+0.083*X2)*m0;
...
function [J,D1] = current(mm,m1,m21,m22, Volt, En,dE, NE, a, b1, b2, U1, U2, e, kT, hbar, mu, N1, x1)                             %#ok<INUSL> 
